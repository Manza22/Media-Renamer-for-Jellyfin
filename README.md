...
**Please use it responsibly.** This tool is meant to **organize your own media library** with files you have the right to use. Do **not** bundle, modify, or distribute this software—or derivatives of it—as **malware, spyware, ransomware**, or anything designed to harm users, steal data, or run without informed consent. The authors do not support or endorse malicious use.
...
- Be honest that your build is a fork (not the official “Media Renamer”)
...
| **Source code** | This repository — run `python media_renamer.py` |
...
- **Scan & preview** — dry run by default; nothing moves until you apply
- **Movies** — `Title (Year).mp4`; optional copy into genre subfolders
- **TV shows** — `Show - S##E## - Episode Title.mp4` under `Show Name/Season XX/`
- **Flat-season remap** — when a download site labels everything `S01`, map episodes to the correct TMDB seasons
...
- [The Movie Database (TMDB)](https://www.themoviedb.org/) — metadata. This product uses the TMDB API but is **not endorsed or certified by TMDB**.
- [Jellyfin](https://jellyfin.org/) — **not affiliated**. Naming conventions target Jellyfin-style libraries.

## Disclaimer

This software renames and moves files on your computer. **Always use dry run first** and keep backups. The authors are not liable for lost or misnamed files. You must comply with TMDB’s terms and your local laws regarding your media.
